...
const fileBudgets = {
  ...
  "native/zero-c/src/checker.c": { maxLines: 9230, maxStrcmpCalls: 279 },
...
const knownLargeFunctionLimits = new Map([
  ...
  ["native/zero-c/src/checker.c|static bool check_expr_expected(CheckContext *ctx, const Program *program, const Expr *expr, Scope *scope, ZDiag *diag, const char *expected) {", 594],
